...
public class Student {
    ...
    /*
                 Encapsulation yapilmis data'yi okayabilir miyiz?
    -get method'lar (getter) encapsule edilmis (saklanmis) data'yi okamamiza yarar.
    -get method'lar (getter) her zaman "public" olur
    -get method'lar (getter) retur type'i variable'in data type'i ile ayni olur.
    ...
    //Encapsulition yapilmis data'larin degeri degistirilebilir mi?
    /*
