...
public class Lambda03 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(" \n  *******");
        System.out.println(katSayisi2FazlaOlanKirayaGoreSiralayacakEnBuyukKirayiYazdiracak(daireler));
        System.out.println(" \n  *******");
        System.out.println(katSayisi3denAzKirayaGoreKucuktenBuyugeSiralaEnKucukKirayiListYazdir(daireler));
        System.out.println(" \n  *******");
    }
    ...
    public static List<Integer> katSayisi2FazlaOlanKirayaGoreSiralayacakEnBuyukKirayiYazdiracak(List<Apartman> daireler){
 ...
 List<Integer>sonuc=daireler.
    ...
    public static List<Integer> katSayisi3denAzKirayaGoreKucuktenBuyugeSiralaEnKucukKirayiListYazdir(List<Apartman> daireler){
