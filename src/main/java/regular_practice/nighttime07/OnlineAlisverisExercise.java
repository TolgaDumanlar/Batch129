...
public class OnlineAlisverisExercise {
    /*
    ...
    public static void main(String[] args) {
        ...
        urunFiyatlari.add(200.00);
        urunFiyatlari.add(50.00);
        urunFiyatlari.add(10.00);
        urunFiyatlari.add(500.00);
    ...
    private static void odeme() {
        ...
        if(date.isEqual(kurulusGunumuz)){
            System.out.println("Bugn bizim kurulus gunumuz.Borcunuz yoktur");
        }else{
