...
public class C01_ForLoop {
    public static void main(String[] args) {
        /*Kullanicidan aldiginiz bir String degerde 'c'den onceki 'a' harfinin string deger deger icerisinde kac kez
        gectigini bulan kodu yaziniz
         */
        Scanner input=new Scanner(System.in);
        System.out.println("Lutfen String bir data giriniz");
        String sdr=input.nextLine().toLowerCase();
